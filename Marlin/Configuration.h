...
#define STRING_CONFIG_H_AUTHOR "(John 20/12/20)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 480, 480, 15, 100}
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { +46, -52, 0 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 50       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
